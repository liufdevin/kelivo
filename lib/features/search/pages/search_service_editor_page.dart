...
class _SearchServiceEditorPageState extends State<SearchServiceEditorPage> {
  ...
  List<Widget> _configurationFields(
    ...
    if (service is GoogleSearchOptions) {
      return [
        field(
          key: 'apiKey',
  ...
  void _initializeControllers(SearchServiceOptions service) {
    ...
    if (service is DuckDuckGoOptions) {
      ...
      _putController('apiKey', service.apiKey);
      _putController('searchEngineId', service.searchEngineId);
    ...
    switch (_selectedType) {
      ...
      case 'google':
        return GoogleSearchOptions(
          id: _serviceId,
          apiKey: _text('apiKey'),
          searchEngineId: _text('searchEngineId'),
        );
      case 'metaso':
...
String _typeForService(SearchServiceOptions service) {
  ...
  if (service is GoogleSearchOptions) return 'google';
...
SearchServiceOptions _defaultService(String type, String id) {
  switch (type) {
    ...
    case 'google':
      return GoogleSearchOptions(id: id, apiKey: '', searchEngineId: '');
    case 'metaso':
